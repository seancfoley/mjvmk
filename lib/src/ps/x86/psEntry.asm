...
;
;	It then calls start() to run any linked C program that has been compiled 
...
;
;
; c:\projects\mjvmk\boot\entry\entry.obj
...
; Call start(), which is not expected to return.

    call _start

; In case start() returns, enter an infinite loop.
